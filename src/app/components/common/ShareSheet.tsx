    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <ShareSheetContent className="rounded-t-2xl">
        <div className="relative flex  flex-col items-center">
          {/* Cat Image */}
          <div
            className={`absolute -top-40 -z-10 transition-all duration-500 ease-out ${isCatVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-10 scale-75'}`}
          >
            <Image
              src="/images/ic_share_cat.png"
              alt="Share Cat"
              width={200}
              height={200}
            />
          ...
          {/* Confirm Button */}
          <DialogPrimitive.Close asChild className="w-full mt-20">
            <Button
              className="w-full py-4 text-base font-semibold text-white rounded-xl bg-gradient-to-r from-yellow-main to-yellow-light"
            >
              확인했어요
            </Button>
